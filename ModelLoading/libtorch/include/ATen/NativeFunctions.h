...
CAFFE2_API std::tuple<Tensor,Tensor,Tensor> _btrifact_helper_cpu(const Tensor & self, bool pivot);
CAFFE2_API std::tuple<Tensor,Tensor,Tensor> _btrifact_helper_cuda(const Tensor & self, bool pivot);
